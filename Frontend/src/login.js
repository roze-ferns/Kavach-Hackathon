            ...
            <div className="h-screen bgimage flex justify-center items-center space-x-10 ">
                <div className="bg-white w-[700px] h-auto rounded-3xl flex flex-col space-y-6 justifiy-center items-center">
                    ...
                    <form className="flex flex-col space-y-10 justify-center items-center">
                            <div>
                                <label htmlFor="phonenumber" className="text-black text-xl text-purple-violent font-bold">Phone Number: <span className="text-red-800">*</span></label>
                    ...
                    <div className="text-white">
                        <p className="text-red-800 text-sm">* Required Fields</p>
                        <p className="text-xl text-black">Don't have account?</p>
                        <p to='/Login' className="text-2xl text-black text-center mb-5 underline cursor-pointer hover:text-red-600">Create Account</p>
                    </div>
                </div>
            </div>
        </>
